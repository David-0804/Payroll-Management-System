...
void bottomborder(int, int,int, int);
...
void topborder(int xLenS = 2, int yLenS = 2,int xLenE = 76, int yLenE = 22){
	gotoXY(xLenS,yLenS);printf("%c",201);
...
void bottomborder(int xLenS = 2, int yLenS = 2,int xLenE = 76, int yLenE = 22){
	gotoXY(xLenE,yLenS);printf("%c",187);
    gotoXY(xLenE,yLenE);printf("%c",188);
    for(int i=yLenS+1;i<=yLenE-1;i++)         //Left and Right Border Line
    {
...
void intro()
{
    ...
    gotoXY(20,8); printf("Press Any key to continue...");
	bottomborder();
